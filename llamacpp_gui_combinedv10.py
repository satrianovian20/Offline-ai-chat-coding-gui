...
def generate_chunks_with_delay():
    ...
    def run_chunks():
        ...
        for i in range(total_chunks):
            try:
                combined_prompt = (context_memory + "\n" + full_prompt + f"\n\nTuliskan bagian ke-{i+1} sebanyak ~{words_per_chunk} kata:\n").strip()
                max_prompt_tokens = 4096 - max_tokens
                ...
                # Tambahkan ke konteks untuk chunk berikutnya
                context_memory += "\n" + content
