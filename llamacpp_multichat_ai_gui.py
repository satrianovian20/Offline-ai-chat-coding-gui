...
class MultichatAI:
    ...
    def send_prompt(self, entry, display, use_chunk, delay, tab_index, memory_mode, stop_event):
        ...
        threading.Thread(target=self.query_server, args=(full_prompt, display, use_chunk, delay, tab_index, stop_event, system_prompt)).start()

    def query_server(self, prompt, display, use_chunk, delay, tab_index, stop_event, system_prompt):
        try:
